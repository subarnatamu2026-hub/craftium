...
register(
    id="Craftium/OpenWorldDataset-v0",
    entry_point="craftium.craftium_env:CraftiumEnv",
    additional_wrappers=[
        WrapperSpec(
            name="DiscreteActionWrapper",
    ...
    # kwargs
    kwargs=dict(
        env_dir=os.path.join(root_path, "craftium-envs/openworld-dataset"),
        obs_width=320,
        obs_height=180,
        max_timesteps=10_000,
        init_frames=200,
...
register(
    id="Craftium/OpenWorldCreative-v0",
    entry_point="craftium.craftium_env:CraftiumEnv",
    additional_wrappers=[
        WrapperSpec(
            name="DiscreteActionWrapper",
    ...
    # kwargs
    kwargs=dict(
        env_dir=os.path.join(root_path, "craftium-envs/openworld-creative"),
        obs_width=320,
        obs_height=180,
        max_timesteps=10_000,
        init_frames=200,
